          ...
          <div className="flex items-center justify-between px-6 py-3">
            ...
            <div className="flex-1 mx-4 md:mx-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-sm focus:outline-none focus:border-primary placeholder-gray-500"
                />
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <div className="relative group">
                <button className="flex items-center gap-1 text-sm font-medium text-navy hover:text-primary transition">
                  Features
                  <ChevronDown className="h-4 w-4" />
                </button>
                <div className="absolute right-0 mt-0 w-48 bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition p-2">
                  <Link
                    href="/tax-help"
                    className="block px-4 py-2 text-sm text-navy hover:bg-gray-100 rounded"
                  >
                    Tax Help
                  </Link>
                  <Link
              ...
              <Link href="/about" className="text-sm font-medium text-navy hover:text-primary transition">
                About
              </Link>

              <Link href="/contact" className="text-sm font-medium text-navy hover:text-primary transition">
                Contact
              </Link>
        ...
        <div className="fixed top-20 left-0 right-0 z-40 md:hidden">
          <div className="bg-white border-b border-gray-200 p-4 space-y-3">
            <button
              ...
              className="w-full text-left px-4 py-2 font-medium text-navy hover:bg-gray-100 rounded flex items-center justify-between"
            >
              Features
            ...
            {showFeatures && (
              <div className="pl-4 space-y-2">
                <Link href="/tax-help" className="block px-4 py-2 text-sm text-navy hover:bg-gray-100 rounded">
                  Tax Help
                </Link>
                <Link href="/schemes" className="block px-4 py-2 text-sm text-navy hover:bg-gray-100 rounded">
                  Scheme Matching
                </Link>
                <Link href="/csc-finder" className="block px-4 py-2 text-sm text-navy hover:bg-gray-100 rounded">
                  CSC Finder
                </Link>
                <Link href="/grievance" className="block px-4 py-2 text-sm text-navy hover:bg-gray-100 rounded">
                  Log Grievance
                </Link>
              </div>
            )}
            <Link href="/about" className="block px-4 py-2 font-medium text-navy hover:bg-gray-100 rounded">
              About
            </Link>
            <Link href="/contact" className="block px-4 py-2 font-medium text-navy hover:bg-gray-100 rounded">
              Contact
            </Link>
            <Link
              href="/login"
